...
const MockupList = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await axios.delete(`${API_URL}/Mockup/${selectedMockupId}`);
                      ...
                      <TableCell className="dark:text-white">
                        <div className="relative w-12.5 h-12.5">
                          <Image 
                            ...
                            loading="lazy"
                            placeholder="blur"
                            blurDataURL="data:image/jpeg;base64,"
                          />
                        </div>
                      </TableCell>
